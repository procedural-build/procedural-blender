...
* Download the latest *stable* release from GitHub here:
  * https://github.com/procedural-build/procedural-blender/releases/download/latest/procedural_compute.zip
